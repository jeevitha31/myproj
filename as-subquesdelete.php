                            ...
                            <div class="content table-responsive table-full-width">
								<div class="row">
									...
									<div class="col-md-12">
										<div class="col-md-9">
										<?php
										if(isset($_POST["all_subpackage"])){
											$_SESSION['deletesub_ques'] = $_POST["all_subpackage"];
										}
										?>
											<p><strong><u>DELETE AND REMOVE QUESTIONS FROM SUB-PACKAGE: <?php echo $_SESSION['deletesub_ques']; ?></u></strong></p>
											<form action = "as-package.php" method = "post">
										
												<?php
													$package_test_question = "SELECT * FROM `as_question` WHERE  `subpackage` = '".$_SESSION['deletesub_ques']."'";
												...
												?>
												<br/>
												<input type="hidden" name="subpackage" value="<?php echo $_SESSION['deletesub_ques'] ?>">
												<input type = "submit" name = "deletesub_question" value = "Delete Questions" class="btn btn-danger col-md-2" >
												<input type = "submit" name = "removesub_question" value = "Remove Questions From subpackage" class="btn btn-info col-md-5" >
